                        ...
                        <div class="cr-card card-default product-list">
                            <div class="cr-card-content ">
                                <div class="table-responsive">
                                    <center><a href="?act=create-state" class="btn btn-warning">Thêm mới</a></center>
                                                        ...
                                                        <div class="d-flex justify-content-center">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item"
                                                                    href="index.php?act=edit-state&id=<?= $state['state_id'] ?>">Edit</a>
                                                                <a class="dropdown-item"
                                                                    href="index.php?act=delete-state&id=<?= $state['state_id'] ?>">Delete</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
