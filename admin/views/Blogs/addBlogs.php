                        ...
                        <div class="cr-card card-default">
                            <div class="cr-card-content">
                                <div class="row cr-product-uploads">
                                    ...
                                    <!-- Nhập dữ liệu để thêm -->
                                    <div class="col-lg-8">
                                        <div class="cr-vendor-upload-detail">
                                            <form class="row g-3" action="?act=post-add-blog" method="POST"
                                                enctype="multipart/form-data">
                                                <div class="col-md-9">
                                                    <label for="title" class="form-label">Tiêu đề</label>
                                                    <input type="text" class="form-control slug-title" name="title"
                                                        id="title"
                                                        value="<?= htmlspecialchars($_SESSION['old_data']['title'] ?? '') ?>">
                                                    <span id="error_title" style="color: red;">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <input type="text" class="form-control" name="description"
                                                        id="description"
                                                        value="<?= htmlspecialchars($_SESSION['old_data']['description'] ?? '') ?>">
                                                    <span id="error_description" style="color: red;">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <textarea class="form-control" name="content"
                                                        id="content"><?= htmlspecialchars($_SESSION['old_data']['content'] ?? '') ?></textarea>
                                                    <span id="error_content" style="color: red;">
                                                        <?= $_SESSION['errors']['content'] ?? '' ?>
                                                    </span>
                                                </div>
                                                <div class="col-md-12">
                                                    <button type="submit" name="btn_submit"
                                                        class="btn cr-btn-primary">Gửi</button>
                                                </div>
                                            </form>
