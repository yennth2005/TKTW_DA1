                                ...
                                <div class="row cr-product-uploads">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="cr-vendor-upload-detail">
                                            <form class="row g-3" action="?act=post-update-blog&id=<?= $posts['id'] ?>"
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <input type="file" class="form-control slug-title" name="img"
                                                        id="img">
                                                </div>
                                                <div class="col-md-9">
                                                    <label for="description" class="form-label">Tên danh mục</label>
                                                    <input type="text" class="form-control slug-title"
                                                        name="description" id="description"
                                                        value="<?= $posts['description'] ?>">
                                                </div>
                                                <div class="col-md-9">
                                                    <label for="content" class="form-label">Tên danh mục</label>
                                                    <input type="text" class="form-control slug-title" name="content"
                                                        id="content" value="<?= $posts['content'] ?>">
                                                </div>
                                                <div class="col-md-12">
