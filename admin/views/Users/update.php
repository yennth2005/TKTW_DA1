                                ...
                                <div class="row cr-product-uploads">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="cr-vendor-upload-detail">
                                            <form class="row g-3" action="?act=post-update-user&id=<?= $customer['customer_id']?>" method="POST"
                                            ...
                                            <div class="col-md-6">
													...
													<input type="text" class="form-control slug-title" name="name" value="<?= $customer['name'] ?>">
												</div>
												<div class="col-md-6">
													<label for="email" class="form-label">Email</label>
													<input type="text" class="form-control slug-title" name="email" value="<?= $customer['email'] ?>">
												</div>
												<div class="col-md-6">
													<label for="password" class="form-label">Mật khẩu</label>
													<input type="password" class="form-control slug-title" name="password">
												</div>
                                                <div class="col-md-6">
													<label class="form-label">Vai trò</label>
													<select class="form-control form-select" name="role">
															<option value="0" <?= $customer['role'] === 0 ?'selected':''?> >User</option>
															<option value="1" <?= $customer['role'] ===  1 ?'selected':''?> >Admin</option>
													</select>
												</div>
												<div class="col-md-6">
													<label for="address" class="form-label">Địa chỉ</label>
													<input type="text" class="form-control slug-title" name="address" value="<?= $customer['address'] ?>">
												</div>
												<div class="col-md-12">
													<label for="phone" class="form-label">Số điện thoại</label>
													<input type="text" class="form-control slug-title" name="phone" value="<?= $customer['phone'] ?>">
												</div>
												
                                                <div class="col-md-12">
                                                    <button type="submit" name="btn_submit" class="btn cr-btn-primary">Submit</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
