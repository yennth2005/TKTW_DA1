					...
					<div class="cr-hover-drop">
						...
						<div class="cr-hover-drop-panel right">
							<ul>
								...
								<li><a href="javascript:void(0)"><img class="flag"
											src="<?= BASE_URL_ADMIN_VIEW ?>assets/img/flag/in.png" alt="flag">Hindi</a>
								</li>
								<li><a href="javascript:void(0)"><img class="flag"
						...
						<div class="cr-hover-drop-panel right">
							...
							<ul>
								<li><a href="javascript:void(0)"><img class="app"
											src="<?= BASE_URL_ADMIN_VIEW ?>assets/img/apps/1.png" alt="flag">English</a>
								</li>
								<li><a href="javascript:void(0)"><img class="app"
											src="<?= BASE_URL_ADMIN_VIEW ?>assets/img/apps/2.png" alt="flag">Hindi</a>
								</li>
								<li><a href="javascript:void(0)"><img class="app"
											src="<?= BASE_URL_ADMIN_VIEW ?>assets/img/apps/3.png" alt="flag">
										Deutsch</a></li>
								<li><a href="javascript:void(0)"><img class="app"
											src="<?= BASE_URL_ADMIN_VIEW ?>assets/img/apps/4.png" alt="flag">Italian</a>
								</li>
								<li><a href="javascript:void(0)"><img class="app"
				...
				<div class="cr-right-tool cr-user-drop">
					<div class="cr-hover-drop">
						...
						<div class="cr-hover-drop-panel right">
							...
							<ul class="border-top">
								<li><a href="<?= BASE_URL?>?act=logout"><i class="ri-logout-circle-r-line"></i>Logout</a></li>
							</ul>
						</div>
					</div>
				</div>
