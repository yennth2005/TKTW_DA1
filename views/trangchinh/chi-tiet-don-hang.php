...
<body class="body-bg-6">
    ...
    <table>
        ...
        <tr>
            <th>Địa chỉ nhận</th>
            <td><?php echo $orderDetails['recipient_address']; ?></td>
        </tr>
        <tr>
            <th>Tổng tiền</th>
            <td><?php echo number_format($orderDetails['total_amount'], 2); ?> VND</td>
        </tr>
        <tr>
            <th>Trạng thái</th>
            <td><?php echo $orderDetails['state_id'] == 1 ? 'Đang xử lý' : 'Đã hủy'; ?></td>
        </tr>
    </table>
        ...
        <tbody>
            <?php foreach ($orderItems as $item): ?>
                <tr>
                    ...
                    <td><?php echo number_format($item['total_price'], 2); ?> VND</td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>

    <a href="index.php?act=theo-doi-don-hang">Quay lại danh sách đơn hàng</a>
