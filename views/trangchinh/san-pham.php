    ...
    <section class="section-products padding-t-100">
        <div class="container">
            ...
            <div class="row mb-minus-24">
                <div class="col-lg-4 col-md-6 col-6 cr-product-box mb-24" data-aos="fade-up" data-aos-duration="2000"
                    data-aos-delay="300">
                    <div class="cr-product-csc cr-product-card">
                        <div class="cr-product-image">
                            <div class="cr-image-inner">
                                <img src="assets/img/product/1.jpg" alt="product-3">
                                <div class="cr-side-view">
                                    <a href="javascript:void(0)" class="wishlist">
                                        <i class="ri-heart-line"></i>
                                    </a>
                ...
                <div class="col-lg-4 col-md-6 col-6 cr-product-box mb-24" data-aos="fade-up" data-aos-duration="2000"
                    ...
                    <div class="cr-product-csc cr-product-card">
                        <div class="cr-product-image">
                            <div class="cr-image-inner">
                                <img src="assets/img/product/2.jpg" alt="product-3">
                                <div class="cr-side-view">
                                    <a href="javascript:void(0)" class="wishlist">
                                        <i class="ri-heart-line"></i>
                                    </a>
                ...
                <div class="col-lg-4 col-md-6 col-6 cr-product-box mb-24" data-aos="fade-up" data-aos-duration="2000"
                    ...
                    <div class="cr-product-csc cr-product-card">
                        ...
                        <div class="cr-product-details">
                            <a href="product-left-sidebar.html" class="title">Organic fresh venila farm watermelon 5kg</a>
                            <p>Lorem ipsum dolor adipisicing elit.</p>
                            <div class="cr-star">
                                <i class="ri-star-fill"></i>
                                <i class="ri-star-fill"></i>
            ...
            <div class="row mb-minus-24">
                ...
                <div class="col-lg-3 col-6 cr-product-box mb-24" data-aos="fade-up" data-aos-duration="2000"
                    ...
                    <div class="cr-product-csc cr-product-card">
                        <div class="cr-product-image">
                            <div class="cr-image-inner">
                                <img src="assets/img/product/4.jpg" alt="product-3">
                                <div class="cr-side-view">
                                    <a href="javascript:void(0)" class="wishlist">
                                        <i class="ri-heart-line"></i>
                                    </a>
