...
<!-- Mirrored from maraviyainfotech.com/projects/carrot/carrot-v21/carrot-html/elements-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Nov 2024 15:30:30 GMT -->
...
<body class="body-bg-6">
                        ...
                        <div class="cr-shop-sideview">
                            <div class="cr-shop-categories">
                                ...
                                <div class="cr-checkbox">
                                    <?php foreach ($catePro as $cate): ?>
                                        <div class="checkbox-group">
                                            <input type="checkbox" id="<?= $cate['category_code'] ?>" name="categories[]"
                                                value="<?= $cate['category_id'] ?>">
                                            <label for="<?= $cate['category_code'] ?>"><?= $cate['category_name'] ?></label>
                            ...
                            <div class="cr-shop-price">
                                ...
                                <div class="price-range-input">
                                    ...
                                    <input type="number" id="max_price" name="max_price" placeholder="Không giới hạn"
                                        max="100000000">
                                </div>
                            </div>
                            <button type="submit" class="cr-button" name="btn_filter" id="filter-button">Filter</button>
                    ...
                    <div class="col-12">
                        <div class="cr-shop-bredekamp">
                            ...
                            <div class="center-content">
                                <span>We found items for you!</span>
                            </div>
                            <div class="cr-select">
                                <label>Sort By :</label>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-6 cr-product-box mb-24">
                                <div class="cr-product-card">
                                    ...
                                    <div class="cr-product-details">
                                        ...
                                        <a href="?act=view-detail&color=<?= $product['color_id'] ?>"
                            ...
                            <div class="col-xxl-3 col-xl-4 col-6 cr-product-box mb-24">
                                <div class="cr-product-card">
                                    ...
                                    <div class="cr-product-details">
                                        ...
                                        <p class="cr-price"><span class="new-price"><?= number_format($product['new_price']). "VND" ?></span> <span
                                                class="old-price"><?= number_format($product['old_price']) ?></span></p>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
    ...
    <!-- Product Default Style -->
    <section class="section-products padding-tb-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="mb-30" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="400">
            ...
            <div class="row mb-minus-24">
                <div class="col-lg-3 col-6 cr-product-box mb-24" data-aos="fade-up" data-aos-duration="2000"
                    data-aos-delay="300">
                    <div class="cr-product-csc cr-product-card">
                        <div class="cr-product-image">
                            <div class="cr-image-inner">
                                <img src="<?= BASE_URL_VIEW ?>assets/img/product/1.jpg" alt="product-3">
                                <div class="cr-side-view">
                                    <a href="javascript:void(0)" class="wishlist">
                                        <i class="ri-heart-line"></i>
                                    </a>
                        ...
                        <div class="cr-product-details">
                            <a href="product-left-sidebar.html" class="title">Organic fresh lemon</a>
                            <p>Lorem ipsum dolor impicit adipisicing elit.</p>
                            <div class="cr-star">
                                <i class="ri-star-fill"></i>
                                <i class="ri-star-fill"></i>
                                <i class="ri-star-fill"></i>
                ...
                <div class="col-lg-3 col-6 cr-product-box mb-24" data-aos="fade-up" data-aos-duration="2000"
                    ...
                    <div class="cr-product-csc cr-product-card">
                        <div class="cr-product-image">
                            <div class="cr-image-inner">
                                <img src="<?= BASE_URL_VIEW ?>assets/img/product/2.jpg" alt="product-3">
                                <div class="cr-side-view">
                                    <a href="javascript:void(0)" class="wishlist">
                                        <i class="ri-heart-line"></i>
                                    </a>
                        ...
                        <div class="cr-product-details">
                            <a href="product-left-sidebar.html" class="title">Organic fresh apple juice</a>
                            <p>Lorem ipsum dolor impicit adipisicing elit.</p>
                            <div class="cr-star">
                                <i class="ri-star-fill"></i>
                                <i class="ri-star-fill"></i>
                ...
                <div class="col-lg-3 col-6 cr-product-box mb-24" data-aos="fade-up" data-aos-duration="2000"
                    ...
                    <div class="cr-product-csc cr-product-card">
                        <div class="cr-product-image">
                            <div class="cr-image-inner">
                                <img src="<?= BASE_URL_VIEW ?>assets/img/product/3.jpg" alt="product-3">
                                <div class="cr-side-view">
                                    <a href="javascript:void(0)" class="wishlist">
                                        <i class="ri-heart-line"></i>
                                    </a>
                        ...
                        <div class="cr-product-details">
                            <a href="product-left-sidebar.html" class="title">Organic watermelon 5kg</a>
                            <p>Lorem ipsum dolor impicit adipisicing elit.</p>
                            <div class="cr-star">
                                <i class="ri-star-fill"></i>
                                <i class="ri-star-fill"></i>
                ...
                <div class="col-lg-3 col-6 cr-product-box mb-24" data-aos="fade-up" data-aos-duration="2000"
                    ...
                    <div class="cr-product-csc cr-product-card">
                        <div class="cr-product-image">
                            <div class="cr-image-inner">
                                <img src="<?= BASE_URL_VIEW ?>assets/img/product/4.jpg" alt="product-3">
                                <div class="cr-side-view">
                                    <a href="javascript:void(0)" class="wishlist">
                                        <i class="ri-heart-line"></i>
                                    </a>
                        ...
                        <div class="cr-product-details">
                            <a href="product-left-sidebar.html" class="title">Organic fresh venila farm</a>
                            <p>Lorem ipsum dolor impicit adipisicing elit.</p>
                            <div class="cr-star">
                                <i class="ri-star-fill"></i>
                                <i class="ri-star-fill"></i>
