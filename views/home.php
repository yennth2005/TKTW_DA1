                        ...
                        <section class="card"> 
                            <section class="imgbox">
                                <a href="?act=desc-pro&id=<?= $array1['product_id']?>">
                                    <div class="card-thumb"><img src="./admin/<?= $array1['product_img']?>" width="200px" height="200px" alt=""></div>
                            ...
                            <div class="card-name"><?php echo $array1['product_name']?></div>
                                ...
                                <form action="" method="POST">
                                    <input type="hidden" name="product_id" value="<?php echo $array1['product_id']; ?>">
                                ...
                                <section class="desc">
                                    ...
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur totam vero obcaecati earum ipsum odit accusamus.</p>
                                </section>
    
                                    <a href="?act=desc-pro&id=<?= $array1['product_id']?>"><button type="submit" class="cart"><a href="?act=desc-pro&id=<?= $array1['product_id']?>">View</a></button></a>
                        ...
                        <section class="card"> 
                            ...
                            <div class="card-name"><?php echo $array1['product_name']?></div>
                                ...
                                <section class="desc">
                                    ...
                                    <a href="?act=desc-pro&id=<?= $array1['product_id']?>"><button type="submit" class="cart">View</button></a>
